  ...
  config = function()
    ...
    cmp.setup({
      ...
      mapping = {
        ...
        -- Tab : si le menu est ouvert, confirme la première suggestion ;
        -- si on est dans un snippet, saute au champ suivant ; sinon Tab normal.
        ...
        -- Shift-Tab : recule dans le snippet, sinon Tab arrière normal.
